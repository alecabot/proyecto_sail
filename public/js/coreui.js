...
(function (global, factory) {
  ...
  */
    ...
    const Default$8 = {
        ...
        required: false,
        search: false,
        searchNoResultsLabel: 'No se han encontrado resultados',
        selectAll: true,
        selectAllLabel: 'Seleccionar todas las opciones',
        selectionType: 'tags',
        selectionTypeCounterText: 'elemento(s) seleccionado(s)',
        valid: false
    };
    const DefaultType$8 = {
        cleaner: 'boolean',
    ...
    class MultiSelect extends BaseComponent {
        ...
        _updateSearch() {
            ...
            if (this._config.multiple && this._config.selectionType === 'counter') {
                this._searchElement.placeholder = `${this._selected.length} elemento(s) seleccionado(s)`;
            }
        }
