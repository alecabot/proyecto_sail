...
<div class="container">
    ...
    <p>Estimado Tutor: {{$parte->alumnos->first()->unidad->profesor->nombre}},</p>
    @if($eliminado)
        <p>Le informamos se ha eliminado un parte de su curso. A continuación, encontrará los detalles:</p>
    @elseif($actualizado)
        <p>Le informamos se ha modificado un parte de su curso. A continuación, encontrará los detalles:</p>
    @else
        <p>Le informamos que se ha emitido un parte de su curso. A continuación, encontrará los detalles:</p>
    @endif
